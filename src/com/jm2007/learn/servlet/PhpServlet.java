...
@WebServlet(urlPatterns = { "/PhpServlet", "/php" }, initParams = {
		@WebInitParam(name = "trainerName", value = "Sia"), @WebInitParam(name = "trainerMobile", value = "43210") })
public class PhpServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String trainerData = String.format("Your tainer is %s and his mobile number is %s in %s", trnName, trnMob, institute);
